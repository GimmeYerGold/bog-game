...
function app() {
	...
	var randInRange = function randInRange(lower, upper) {
		var diff = upper - lower;
		var result = lower + Math.round(diff * Math.random());
		return result;
	};

	var bogValues = function bogValues(i, j) {
	...
	var AppView = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(BogGenerator, null)
			);
		}
	});

	var BogGenerator = _react2.default.createClass({
		displayName: "BogGenerator",

		_getBogDimensions: function _getBogDimensions() {
			var grid = [];
			var sideLength = 10;
			for (var i = 0; i < sideLength; i++) {
				var newPoints = [];
				for (var j = 0; j < sideLength; j++) {
					var newPoint = _react2.default.createElement(Point, { data: new bogValues(i, j) });
					newPoints.push(newPoint);
				}

				var newRow = _react2.default.createElement(Row, { points: newPoints, key: i });
				grid.push(newRow);
			}
			return grid;
		},
		...
		render: function render() {
			return _react2.default.createElement(
				"div",
				{ className: "bogContainer" },
				this._getBogDimensions(),
				_react2.default.createElement(History, { data: archives })
			);
		}
	});
	...
	var Point = _react2.default.createClass({
		...
		_handleClick: function _handleClick(clickEvent) {
		...
		render: function render() {
			if (this.props.data.body) {
				return _react2.default.createElement(
					"div",
					{ onClick: this._handleClick, className: "bogPoint" },
					_react2.default.createElement("img", { src: this.props.data.image })
				);
			} else {

				return _react2.default.createElement("div", { onClick: this._handleClick, className: "bogPoint" });
			}
		}
	});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"p",
						null,
						" You have a fortnight to find as many bog bodies as you can...FOR SCIENCE!"
					)
				)
			);
		}
